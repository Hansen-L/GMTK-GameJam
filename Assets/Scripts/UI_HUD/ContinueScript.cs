...
public class ContinueScript : MonoBehaviour
{
	...
	public void Continue()
	{
		...
		//        GameObject.Find("Doggo").GetComponent<DogMovement>().max_speed = 10;
		//    }
		//    if (GetComponent<TextMeshProUGUI>().text == "DASH STOMP"){
		//        GameObject.Find("Doggo").GetComponent<DogMovement>().dash_jump = true;
		//    }
		//    if (GetComponent<TextMeshProUGUI>().text == "+ BORK STRENGTH"){
		//        GameObject.Find("Doggo").GetComponent<DogMovement>().more_bork = true;
		//    }
		//    if (GetComponent<TextMeshProUGUI>().text == "MAGNETIC BORK"){
		//        GameObject.Find("Doggo").GetComponent<DogMovement>().reverse_bork = true;
		//    }
		...
		//        GameObject.Find("Doggo").GetComponent<DogMovement>().bigger_bork = true;
		//    }
